...
public class AuthController {
    ...
    public String procesarRegistro(Usuario user, HttpServletRequest request,
        ...
        //Si se altera el HTML en el login y se quitan los required, controlo que todo esté completo
        if(user.getEmail() == "" || user.getPass() == "" || user.getNombre() == "" ||
            user.getApellido() == "" || user.getTelefono() == "" || repetirPass == "" ){
            ra.addFlashAttribute("mensaje_error", "Datos incompletos");
